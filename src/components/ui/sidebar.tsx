  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground relative",
            className
          )}
          ref={ref}
          {...props}
        >
          {children}
          <div className="absolute bottom-0 left-0 w-[--sidebar-width] border-t border-border">
            <Notes />
          </div>
        </div>
      )
